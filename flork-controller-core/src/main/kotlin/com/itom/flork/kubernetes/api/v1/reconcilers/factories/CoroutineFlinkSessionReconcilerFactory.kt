...
import com.itom.flork.kubernetes.api.v1.reconcilers.CoroutineFlinkSessionReconciler
import com.itom.flork.kubernetes.api.v1.reconcilers.FlinkSessionReconciler
...
class CoroutineFlinkSessionReconcilerFactory : FlinkSessionReconcilerFactory {
    ...
    override fun stopAll() {
        CoroutineFlinkSessionReconciler.resetScope()
    }
}
